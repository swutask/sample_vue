<template>
  <NodeViewWrapper
    ...
    class="relative ordered-list-item h-full outline-none group-scope"
  ...
  >
    <i
      ...
      class="icon-drag drag-icon pr-4 -ml-40 mt-1 md:opacity-0 group-scope-hover:opacity-100"
      data-drag-handle
      draggable="true"
    ...
    <NodeViewContent
      ...
      data-drag-handle
      class="ordered-list-item-content w-full outline-none"
